  ...
  return (
    <div>
      <div
        ...
        // Stacks directly under the sticky page title bar (top = header height).
        className="sticky top-[var(--app-header-h)] z-20 -mx-1 flex flex-wrap gap-1 border-b border-surface-border bg-surface px-1 py-1"
      >
        {tabs.map((t) => {
