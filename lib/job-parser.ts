...
const SECRET_PATTERNS: { name: string; re: RegExp; severity: string }[] = [
  ...
  { name: "GitLab token", re: /\bglpat-[0-9A-Za-z_-]{20,}\b/, severity: "critical" },
  { name: "Slack token", re: /\bxox[baprs]-[0-9A-Za-z-]{10,}\b/, severity: "high" },
  { name: "Slack webhook", re: /\bhttps:\/\/hooks\.slack\.com\/services\/T[0-9A-Za-z_]+\/B[0-9A-Za-z_]+\/[0-9A-Za-z_]{20,}\b/, severity: "high" },
